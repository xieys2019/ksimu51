...
class MAX765x:  public I80C52, public I8031_ADConverter, public I8051_Flash
{
	...
	protected:
		...
		void add_A_DIRECT(unsigned int const directAddress);
		void addc_A_DIRECT(unsigned int const directAddress);
		void subb_A_DIRECT(unsigned int const directAddress);
		void inc_DIRECT(unsigned int const directAddress);
		void dec_DIRECT(unsigned int const directAddress);
		void inc_DPTR(void);
		void anl_A_DIRECT(unsigned int const directAddress);
		void anl_DIRECT_A(unsigned int const directAddress);
		void mov_DIRECT_RNx(unsigned char const instruction, unsigned int const directAddress);
		void anl_DIRECT_DATA(unsigned int const directAddress, unsigned int const data);
		void orl_A_DIRECT(unsigned int const directAddress);
		void orl_DIRECT_A(unsigned int const directAddress);
		void orl_DIRECT_DATA(unsigned int const directAddress, unsigned int const data);
		void xrl_A_DIRECT(unsigned int const directAddress);
		void xrl_DIRECT_A(unsigned int const directAddress);
		void xrl_DIRECT_DATA(unsigned int const directAddress, unsigned int const data);
		void mov_A_DIRECT(unsigned int const directAddress);
		void mov_RNx_DIRECT(unsigned char const instruction, unsigned int const directAddress);
		void mov_DIRECT_A(unsigned int const directAddress);
		void mov_DIRECT_DIRECT(unsigned int const srcDirectAddress, unsigned int const dstDirectAddress);
		void mov_DIRECT_RIx(unsigned char const instruction, unsigned int const directAddress);
		void mov_DIRECT_DATA(unsigned int const directAddress, unsigned int const data);
		void mov_RIx_DIRECT(unsigned char const instruction, unsigned int const directAddress);
		void mov_DPTR_DATA16(unsigned char const dph, unsigned char const dpl);
		void pop_DIRECT(unsigned int const directAddress);
		void push_DIRECT(unsigned int const directAddress);
		void xch_A_DIRECT(unsigned int const directAddress);
		void cjne_A_DIRECT_REL(unsigned int const directAddress, char const relAddress);
		void djnz_DIRECT_REL(unsigned int const directAddress, char const relAddress);
