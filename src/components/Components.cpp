...
ExternalComponentW* Components::addComponent(QWidget * parent, int const  type, int const  componentIndexCounter)
{
	QString indexQStr;
	indexQStr.setNum(componentIndexCounter,10);

	ExternalComponentW* pointerToEDMCW=addComponent_VirtualPart(parent, type, componentIndexCounter, indexQStr);
	if(pointerToEDMCW)
	{
